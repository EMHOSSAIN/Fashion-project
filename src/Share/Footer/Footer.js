...
const Footer = () => {
  return (
    <div className='mt-10 px-5 bg-gray-100'>
          ...
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div class="mb-10 w-full">
                <Link to ="/" class="mb-6 inline-block max-w-[160px]">
                  <img
                    src="brand-logo.webp"
                    alt="logo"
                    class="max-w-full"
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div class="mb-10 w-full">
                ...
                <p class="text-body-color text-base">@Copyright Goenka's Fashion 2023</p>
              </div>
            </div>
          </div>
        </div>
